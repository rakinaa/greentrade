  ...
  return (
    <div>
      <div className="news-commissions">
        <h3 className="comm-heading">Break Free from Commission Fees</h3>
        <p className="comm-body">
          Make unlimited commission-free trades in stocks, ETFs, and options
          with Greentrade Financial, as well as buy and sell cryptocurrencies
          with Greentrade Crypto. See our fee schedule to learn more about cost.
        </p>
      ...
      <div className="news-fractional">
        <div className="frac-content">
          <h3 className="frac-heading">Introducing Fractional Shares</h3>
          ...
          <div className="frac-body">
            <div className="frac-sub-content">
              <h3 className="frac-sub-heading">Invest Any Amount</h3>
            ...
            <div className="frac-sub-content">
              <h3 className="frac-sub-heading">Build a Balanced Portfolio</h3>
              <p className="frac-sub-body">
            ...
            <div className="frac-sub-content">
              <h3 className="frac-sub-heading">Trade in Real Time</h3>
              <p className="frac-sub-body">
